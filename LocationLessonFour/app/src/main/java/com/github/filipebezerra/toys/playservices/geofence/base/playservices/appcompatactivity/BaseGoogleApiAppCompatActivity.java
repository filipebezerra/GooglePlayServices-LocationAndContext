package com.github.filipebezerra.toys.playservices.geofence.base.playservices.appcompatactivity;
...
import static com.github.filipebezerra.toys.playservices.geofence.base.playservices.util.CommonGoogleApiConnectionErrorMessages.getConnectionResultErrorMessage;
import static com.github.filipebezerra.toys.playservices.geofence.base.playservices.util.CommonGoogleApiConnectionErrorMessages.getConnectionSuspendedCauseMessage;
...
public abstract class BaseGoogleApiAppCompatActivity extends AppCompatActivity
    ...
    /**
     * The {@link Toolbar} in the layout provided by {@link #getContentLayoutResId()} if present
     */
    @Bind(R.id.toolbar) protected Toolbar mToolbar;

    /**
     * Descendent classes must provide their own layout resource.
     *
     ...
     * so descendent classes must provide their own Up indicator.
     *
    ...
    /**
     * Provide a list of {@link Api} to {@link GoogleApiClient}. Descendent classes must provide
     ...
     * Descendent classes must provide their own handled Scopes.
     *
    ...
    private void setupToolbarAsActionBar() {
        if (mToolbar != null) {
            ...
            if (actionBar != null) {
                if (getUpIndicatorDrawableResId() != 0) {
    ...
    @Override public void onConnectionSuspended(int cause) {
        ...
        Timber.i("The cause: %s", getConnectionSuspendedCauseMessage(cause));
        mGoogleApiClient.connect();
    }
